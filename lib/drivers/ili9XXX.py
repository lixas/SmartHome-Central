...
ROTATE_0_MIRROR = 0xC0
ROTATE_90_MIRROR = 0x60
ROTATE_180_MIRROR = 0x00
ROTATE_270_MIRROR = 0xA0
...
class ili9XXX:
    ...
    def __init__(
        ...
        colormode=COLOR_MODE_BGR, rot=ROTATE_0, invert=False, double_buffer=True, half_duplex=True, display_type=0
    ):
        # Initializations
...
#                    esp.spi_transaction_t.SIZE, esp.MALLOC_CAP.DMA))
    ...
    def init(self):
        ...
        if self.backlight != -1:
            esp.gpio_pad_select_gpio(self.backlight)
        if self.power != -1:
            esp.gpio_pad_select_gpio(self.power)
...
class ili9341(ili9XXX):
    ...
    def __init__(
        self, miso=5, mosi=18, clk=19, cs=13, dc=12, rst=4, power=14, backlight=15, backlight_on=0, power_on=0,
        spihost=esp.HSPI_HOST, mhz=40, factor=4, hybrid=True, colormode=COLOR_MODE_BGR,
        rot=ROTATE_0, invert=False, double_buffer=True, half_duplex=True
    ):
        ...
        if rot in [ROTATE_0, ROTATE_180, ROTATE_0_MIRROR, ROTATE_180_MIRROR]:
            width = 240
            height = 320
        elif rot in [ROTATE_90, ROTATE_90_MIRROR, ROTATE_270, ROTATE_270_MIRROR]:
            width = 320
            height = 240
...
class ili9488(ili9XXX):
    ...
    def __init__(
        ...
        colormode=COLOR_MODE_RGB, rot=ROTATE_0, invert=False, double_buffer=True, half_duplex=True
    ):
